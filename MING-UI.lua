...
local OrionLib = {
	...
	Themes = {
		Default = {
			...
			Second = Color3.fromRGB(0, 255, 151),
			Stroke = Color3.fromRGB(245, 248, 255),
			Divider = Color3.fromRGB(0, 255, 11),
			Text = Color3.fromRGB(0, 248, 255),
			TextDark = Color3.fromRGB(0, 248, 255)
		}
	},
